package session14.dentist.view;
...
public class Menu {
    ...
    private static final int ADD_NEW_DOCTOR_ITEM = 3;
    ...
    private void addNewUser() {
        ...
        Long docId = Long.valueOf(scanIntWithRetry("Input Doctor id"));
        userService.addNewUser(name, surname, age, date, docId, sum);



      //  Client user = new Client(name, surname, age, date, docId, sum);
    ...
    private void addNewDoctor() {
        ...
        System.out.println("Added user " + doctor);
